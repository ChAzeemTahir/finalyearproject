        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title"> <p class="font-italic">Order Edit</p> </h2>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header"><p class="font-italic">Order Edit</p>
                                    </div>
                                    <div class="card-body">
                                        <div class="container">
                                                        <div class="modal-body">
                                                            <form method="post" action="{{url('order_update',$data->id)}}" enctype="multipart/form-data">
                                                                @csrf
                                                                <div>
                                                                </div>
                                                                <div class="row">
