    ...
    <div class="dashboard-wrapper">
        <div class="container-fluid dashboard-content">
            ...
            <div class="row justify-content-center">
                <div class="col-sm-8">
                    <div class="card">
                        <div class="card-header">Comment's
                                ...
                                <div class="table-responsive-sm">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <th> <p class="font-italic">E-mail</p></th>
                                            <th> <p class="font-italic">Comment</p></th>
                                            <th colspan="2"> <p class="font-italic">Action</p></th>
                                        </tr>
                                        </thead>
                                        @foreach($comment as $Show)
                                            <tr>
                                                <td> <p class="font-italic">{{$Show['name']}}</p></td>
                                                <td> <p class="font-italic">{{$Show['email']}}</p></td>
                                                <td> <p class="font-italic">{{$Show['comment']}}</p></td>
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu bg-light container">
                                                            <form action="{{url('delete_comment', $Show['id'])}}" method="post">
                                                                @csrf
