...
{{--                                                                <h2 class="pageheader-title"> <p class="font-italic">Order #{{$orderdetalis->id}}</p> </h2>--}}
                                                                <div class="container">
                                                                    <div class="row justify-content-center">
                                                                        <div class="col-sm-12">
                                                                            <div class="card">
                                                                                <div class="card-header"><p class="font-italic">Send Book </p>
                                                                                    <div class="topnav">
                                                                                    </div>
                                                                                                                    ...
                                                                                                                    <div class="modal-body">
                                                                                                                        <form method="post" action="{{url('sendemail')}}">
                                                                                                                            ...
                                                                                                                            <div class="row">
                                                                                                                                <div class="col-md-4"></div>
                                                                                                                                <div class="form-group col-md-4">
                                                                                                                                    <label for="Number">User E-mail:</label><br>
                                                                                                                                    <input type="text" name="email" value="{{$orderdetalis->email}}">
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                            <div class="row">
                                                                                                                                <div class="col-md-4"></div>
                                                                                                                                <div class="form-group col-md-4">
                                                                                                                                    <label for="Number">Product Name:</label><br>
                                                                                                                                    <input type="text"
                                                                                                                                           name="name" {{ $errors->has('name') ? ' is-invalid' : '' }} required>
                                                                                                                                    @if ($errors->has('name'))
